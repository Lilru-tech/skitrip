...
const API_URL = "https://script.google.com/macros/s/AKfycbxiZhDqPpPTAV4En1UHysdFFljXNpdpi65WEGQQkHCuTjRLjHVdic60duPHmorRrTq4OQ/exec";
...
let groceries = [
  ...
  { id: "chuches", name: "Golosinas / chuches", price: 1.50, quantity: 1, perDay: false },
  { id: "galletas", name: "Galletas (Hacendado)", price: 1.20, quantity: 1, perDay: false },
  { id: "chocolate", name: "Chocolate / turrón", price: 2.70, quantity: 1, perDay: false },

  { id: "tortilla", name: "Tortilla de patata (Hacendado)", price: 2.79, quantity: 1, perDay: false },
  { id: "empanada", name: "Empanada (Hacendado)", price: 1.75, quantity: 1, perDay: false },
  { id: "hummus", name: "Hummus (Hacendado)", price: 1.50, quantity: 1, perDay: false },
  { id: "guacamole", name: "Guacamole (Hacendado)", price: 1.85, quantity: 1, perDay: false },
  { id: "nachos", name: "Nachos (Hacendado)", price: 0.90, quantity: 1, perDay: false },
  { id: "zanahorias", name: "Zanahorias (1 kg aprox.)", price: 1.70, quantity: 1, perDay: false },

  { id: "tomate", name: "Tomate triturado (Hacendado)", price: 0.64, quantity: 2, perDay: false },
  { id: "aceite", name: "Aceite de oliva (Hacendado)", price: 4.20, quantity: 1, perDay: false },
  { id: "jamon", name: "Jamón serrano (Hacendado)", price: 6.50, quantity: 1, perDay: false },

  { id: "leche", name: "Leche semidesnatada (Hacendado)", price: 0.88, quantity: 3, perDay: true },
  { id: "cafe", name: "Café molido (Hacendado)", price: 3.50, quantity: 1, perDay: false },
  { id: "colaCao", name: "Cacao a la taza (Hacendado)", price: 2.20, quantity: 1, perDay: false },
  { id: "bizcocho", name: "Bizcocho / bollería", price: 2.60, quantity: 1, perDay: false },
  { id: "pan", name: "Pan (barra o pan de horno)", price: 1.19, quantity: 2, perDay: true },
  { id: "mantequilla", name: "Mantequilla (Hacendado)", price: 2.50, quantity: 1, perDay: false },
  { id: "mermelada", name: "Mermelada (Hacendado)", price: 1.80, quantity: 1, perDay: false },

  { id: "barritas", name: "Barritas energéticas / chocolate", price: 2.00, quantity: 2, perDay: false },
  { id: "fruta", name: "Fruta (plátanos/mandarinas)", price: 1.80, quantity: 2, perDay: true },

  { id: "coca_cola", name: "Coca-Cola (lata 330 ml)", price: 0.80, quantity: 6, perDay: false },
  { id: "vermut", name: "Vermut (botella)", price: 4.50, quantity: 1, perDay: false },
  { id: "cerveza", name: "Cerveza (Hacendado)", price: 0.80, quantity: 24, perDay: false },
  { id: "agua", name: "Agua (pack)", price: 1.50, quantity: 3, perDay: false },
  { id: "vino", name: "Vino tinto / blanco", price: 3.50, quantity: 2, perDay: false },

  { id: "sal", name: "Sal de mesa (Hacendado)", price: 0.99, quantity: 1, perDay: false },
  { id: "papel_cocina", name: "Papel de cocina", price: 2.50, quantity: 1, perDay: false },
  { id: "lavavajillas", name: "Lavavajillas líquido", price: 1.20, quantity: 1, perDay: false },
  { id: "estropajo", name: "Estropajo", price: 0.99, quantity: 1, perDay: false },
  { id: "bolsas_basura", name: "Bolsas de basura", price: 1.50, quantity: 1, perDay: false },
  { id: "bolsas_congelar", name: "Bolsas de congelar", price: 1.80, quantity: 1, perDay: false }
];
...
function renderGroceriesTable(tripDays) {
  ...
  for (const g of groceries) {
    ...
    nameInput.addEventListener("input", () => scheduleEdit(g.id, { name: nameInput.value }, tripDays));
    ...
    priceInput.addEventListener("input", () => scheduleEdit(g.id, { price: Number(priceInput.value || 0) }, tripDays));
    ...
    qtyInput.addEventListener("input", () => scheduleEdit(g.id, { quantity: Number(qtyInput.value || 0) }, tripDays));
    ...
    perDayInput.addEventListener("change", () => scheduleEdit(g.id, { perDay: perDayInput.checked }, tripDays));
    ...
    delBtn.addEventListener("click", async () => {
      ...
      if (apiReady) {
        try { await apiGroceriesDelete(g.id); } catch (e) {
